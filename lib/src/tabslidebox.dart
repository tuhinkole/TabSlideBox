...
import 'package:tabslidebox/src/tabbarwidget.dart';


class TabSlideBox extends StatefulWidget {
  ...
  @override
  State<TabSlideBox> createState() => _TabSlideBoxState();
}

class _TabSlideBoxState extends State<TabSlideBox> with SingleTickerProviderStateMixin{
